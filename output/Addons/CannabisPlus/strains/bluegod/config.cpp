...
class CfgVehicles
{
	...
	class CP_CannabisBagBlueGod: CP_CannabisBags
	{
		...
		cpStepDownToBud="CP_CannabisBlueGod";
		class Resources
		{
	...
	class CP_CannabisBrickBlueGod: CP_CannabisBrickBase
	{
		...
		cpStepDownToBag="CP_CannabisBagBlueGod";
		class Resources
		{
	...
	class CP_CannabisBlueGod: CP_CannabisBud
	{
		...
		cpStepUpToBag="CP_CannabisBagBlueGod";
		cpStepUpToJoint="CP_JointBlueGod";
		hiddenSelectionsTextures[]=
		{
	...
	class CP_JointPack_BlueGod: CP_JointPack
	{
		...
		descriptionShort="#cp_marijuana_cigarettes_bluegod1";
		cpCheckPack="CP_JointBlueGod";
		hiddenSelections[]=
		{
			"camoGround",
			"zbytek"
