...
class CP_Workbench extends ItemBase 
{
	...
	//int BudsToBagsUsage = GetCPConfig().GetGeneralConfig().Buds_To_Bags_Required;
	int BagsToBricksUsage; //GetCPConfig().GetGeneralConfig().Bags_To_Bricks_Required;	
	...
	void CP_LoadConfig()
	{
		...
		////////////////////////////////////////////////////////////////////////////
		int BatteryRequired = GetCPConfig().GetGeneralConfig().RequireBattery;
		Workbench_Timer_Repeat = GetCPConfig().GetGeneralConfig().Workbench_Processing_Time;
		//int BudsToBagsUsage = GetCPConfig().GetGeneralConfig().Buds_To_Bags_Required;
		BagsToBricksUsage = 16; //GetCPConfig().GetGeneralConfig().Bags_To_Bricks_Required;	


		/*					 Percentile Config Options 0% - 100%                  */
		////////////////////////////////////////////////////////////////////////////

		Battery_Percent = GetCPConfig().GetGeneralConfig().WorkBench_PowerUsed / 100 * 1500;
	
		PlaticWrap_Percent = GetCPConfig().GetGeneralConfig().Plastic_Wrap_Usage;
