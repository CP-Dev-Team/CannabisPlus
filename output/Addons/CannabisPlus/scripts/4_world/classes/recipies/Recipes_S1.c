...
class CP_DeCraftCannabisBagS1 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open S1 Cannabis Bag";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("CP_CannabisS1");//add results here
...
class CP_DeCraftCannabisBrickS1 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open S1 Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		InsertIngredient(0,"CP_CannabisBrickS1");//you can insert multiple ingredients this way
