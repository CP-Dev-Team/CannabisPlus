class CraftCannabisBrickKush extends RecipeBase
{	
	override void Init()
	{
		...
		InsertIngredient(0,"CannabisBagKush");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CannabisBrickKush");//add results here
