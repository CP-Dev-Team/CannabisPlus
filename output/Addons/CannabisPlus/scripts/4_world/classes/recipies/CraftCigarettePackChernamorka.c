class CraftCigarettePackChernamorkaEmpty extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Pack Cigarette into Cigarette Pack";
...
class CraftCigarettePackChernamorka extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Pack Cigarette into Cigarette Pack";
