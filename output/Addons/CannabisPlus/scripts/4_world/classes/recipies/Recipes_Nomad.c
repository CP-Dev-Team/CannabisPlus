...
{	
	override void Init()
	{
		...
		InsertIngredient(0,"CP_CannabisNomad");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1, "CP_CannabisNomad");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CP_CannabisBagNomad");//add results here
...
class CP_CraftCannabisBrickNomad extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Nomad Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		InsertIngredient(0,"CP_CannabisBagNomad");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CP_CannabisBrickNomad");//add results here
...
class CP_CraftCigarettePackNomadEmpty extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Pack Nomad joint into Cigarette Pack";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		InsertIngredient(0,"CP_JointNomad");//you can insert multiple ingredients this way
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		...
		//result1
		AddResult("CP_CigarettePack_CannabisNomad");//add results here
...
class CP_CraftCigarettePackNomad extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Pack Nomad joint into Cigarette Pack";
		...
		InsertIngredient(0,"CP_JointNomad");
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		m_IngredientAddQuantity[0] = 0;// 0 = do nothing
		m_IngredientDestroy[0] = true;//true = destroy, false = do nothing
		...
		InsertIngredient(1, "CP_CigarettePack_CannabisNomad");
		m_IngredientAddHealth[1] = 0;// 0 = do nothing
		m_IngredientSetHealth[1] = -1; // -1 = do nothing
		m_IngredientAddQuantity[1] = 0;// 0 = do nothing
		m_IngredientDestroy[1] = false;// false = do nothing
...
class CP_CraftCigsCannabisNomad extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Roll a joint out of finest Nomad weed";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("CP_JointNomad");//add results here
...
class CP_DeCraftCannabisBagNomad extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Nomad Cannabis Bag";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("CP_CannabisNomad");//add results here
...
class CP_DeCraftCannabisBrickNomad extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Nomad Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		InsertIngredient(0,"CP_CannabisBrickNomad");//you can insert multiple ingredients this way
		...
		m_ResultSetFullQuantity[0] = true;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[0] = 16;//-1 = do nothing
		m_ResultSetHealth[0] = -1;//-1 = do nothing
		m_ResultInheritsHealth[0] = 0;// (value) == -1 means do nothing; a (value) >= 0 means this result will inherit health from ingredient number (value);(value) == -2 means this result will inherit health from all ingredients averaged(result_health = combined_health_of_ingredients / number_of_ingredients)
		m_ResultInheritsColor[0] = -1;// (value) == -1 means do nothing; a (value) >= 0 means this result classname will be a composite of the name provided in AddResult method and config value "color" of ingredient (value)
		m_ResultToInventory[0] == -1;//(value) == -2 spawn result on the ground;(value) == -1 place anywhere in the players inventory, (value) >= 0 means switch position with ingredient number(value)
