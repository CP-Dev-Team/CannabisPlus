class CraftCigsCannabis extends RecipeBase
{	
	override void Init()
	{
		...
		InsertIngredient(0,"Cannabis");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CigarettePack_Cannabis");//add results here
