...
{	
	override void Init()
	{
		m_Name = "Make Skunk Cannabis Bag";
...
class CP_CraftCannabisBrickSkunk extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Skunk Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		InsertIngredient(0,"CP_CannabisBagSkunk");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CP_CannabisBrickSkunk");//add results here
...
{	
	override void Init()
	{
		m_Name = "Pack Skunk joint into Cigarette Pack";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
...
class CP_CraftCigsCannabisSkunk extends RecipeBase
{	
	override void Init()
	{
...
class CP_DeCraftCannabisBagSkunk extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Skunk Cannabis Bag";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("CP_CannabisSkunk");//add results here
...
class CP_DeCraftCannabisBrickSkunk extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Skunk Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		InsertIngredient(0,"CP_CannabisBrickSkunk");//you can insert multiple ingredients this way
