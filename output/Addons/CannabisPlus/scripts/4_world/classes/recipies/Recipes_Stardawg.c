class CP_CraftCannabisBagStardawg extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Stardawg Cannabis Bag";
		...
		InsertIngredient(0,"CP_CannabisStardawg");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1, "CP_CannabisStardawg");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CP_CannabisBagStardawg");//add results here
...
{	
	override void Init()
	{
		m_Name = "Make Stardawg Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
...
class CP_CraftCigarettePackStardawgEmpty extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Pack Stardawg joint into Cigarette Pack";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		InsertIngredient(0,"CP_JointStardawg");//you can insert multiple ingredients this way
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		...
		//result1
		AddResult("CP_CigarettePack_CannabisStardawg");//add results here
...
class CP_CraftCigarettePackStardawg extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Pack Stardawg joint into Cigarette Pack";
		...
		InsertIngredient(0,"CP_JointStardawg");
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		m_IngredientAddQuantity[0] = 0;// 0 = do nothing
		m_IngredientDestroy[0] = true;//true = destroy, false = do nothing
		...
		InsertIngredient(1, "CP_CigarettePack_CannabisStardawg");
		m_IngredientAddHealth[1] = 0;// 0 = do nothing
		m_IngredientSetHealth[1] = -1; // -1 = do nothing
		m_IngredientAddQuantity[1] = 0;// 0 = do nothing
		m_IngredientDestroy[1] = false;// false = do nothing
...
class CP_CraftCigsCannabisStardawg extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Roll a joint out of finest Stardawg weed";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("CP_JointStardawg");//add results here
