class CraftCannabisBrickBlue extends RecipeBase
{	
	override void Init()
	{
		...
		InsertIngredient(0,"CannabisBagBlue");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CannabisBrickBlue");//add results here
