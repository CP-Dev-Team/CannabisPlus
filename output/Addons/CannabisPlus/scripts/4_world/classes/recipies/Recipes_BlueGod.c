...
{	
	override void Init()
	{
		m_Name = "Make Blue God Cannabis Bag";
		...
		InsertIngredient(0,"CP_CannabisBlue");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1, "CP_CannabisBlue");//you can insert multiple ingredients this way
...
class CP_CraftCannabisBrickBlue extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Blue God Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		//result1
		AddResult("CP_CannabisBrickBlue");//add results here
...
class CP_CraftCigarettePackBlueEmpty extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Pack Blue God joint into Cigarette Pack";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		InsertIngredient(0,"CP_JointBlue");//you can insert multiple ingredients this way
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		...
		//result1
		AddResult("CP_CigarettePack_CannabisBlue");//add results here
...
class CP_CraftCigarettePackBlue extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Pack Blue God joint into Cigarette Pack";
		...
		InsertIngredient(0,"CP_JointBlue");
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		m_IngredientAddQuantity[0] = 0;// 0 = do nothing
		m_IngredientDestroy[0] = true;//true = destroy, false = do nothing
		...
		InsertIngredient(1, "CP_CigarettePack_CannabisBlue");
		m_IngredientAddHealth[1] = 0;// 0 = do nothing
		m_IngredientSetHealth[1] = -1; // -1 = do nothing
		m_IngredientAddQuantity[1] = 0;// 0 = do nothing
		m_IngredientDestroy[1] = false;// false = do nothing
...
class CP_CraftCigsCannabisBlue extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Roll a joint out of finest Blue God weed";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
...
class CP_DeCraftCannabisBagBlue extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Blue God Cannabis Bag";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("CP_CannabisBlue");//add results here
...
class CP_DeCraftCannabisBrickBlue extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Blue God Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		InsertIngredient(0,"CP_CannabisBrickBlue");//you can insert multiple ingredients this way
