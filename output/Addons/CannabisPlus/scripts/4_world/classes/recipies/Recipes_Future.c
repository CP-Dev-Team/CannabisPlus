...
class CP_DeCraftCannabisBagFuture extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Future Cannabis Bag";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("CP_CannabisFuture");//add results here
...
class CP_DeCraftCannabisBrickFuture extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Future Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		InsertIngredient(0,"CP_CannabisBrickFuture");//you can insert multiple ingredients this way
