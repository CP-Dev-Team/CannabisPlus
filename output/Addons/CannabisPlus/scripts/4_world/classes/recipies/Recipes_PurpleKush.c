class CP_CraftCannabisBagKush extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Purple Kush Cannabis Bag";
		...
		InsertIngredient(0,"CP_CannabisKush");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1, "CP_CannabisKush");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CP_CannabisBagKush");//add results here
...
class CP_CraftCannabisBrickKush extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Purple Kush Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		InsertIngredient(0,"CP_CannabisBagKush");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CP_CannabisBrickKush");//add results here
...
{	
	override void Init()
	{
		m_Name = "Pack Purple Kush joint into Cigarette Pack";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		InsertIngredient(0,"CP_JointKush");//you can insert multiple ingredients this way
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
...
{	
	override void Init()
	{
		...
		InsertIngredient(0,"CP_JointKush");
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		m_IngredientAddQuantity[0] = 0;// 0 = do nothing
		m_IngredientDestroy[0] = true;//true = destroy, false = do nothing
...
class CP_CraftCigsCannabisKush extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Roll a joint out of finest Purple Kush weed";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
...
class CP_DeCraftCannabisBagKush extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Purple Kush Cannabis Bag";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("CP_CannabisKush");//add results here
...
class CP_DeCraftCannabisBrickKush extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Purple Kush Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		InsertIngredient(0,"CP_CannabisBrickKush");//you can insert multiple ingredients this way
