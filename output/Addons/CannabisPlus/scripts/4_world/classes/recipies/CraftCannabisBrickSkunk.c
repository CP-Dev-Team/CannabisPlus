class CraftCannabisBrickSkunk extends RecipeBase
{	
	override void Init()
	{
		...
		InsertIngredient(0,"CannabisBagSkunk");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CannabisBrickSkunk");//add results here
