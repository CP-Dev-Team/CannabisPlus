modded class PluginRecipesManager 
{
	...
	RegisterRecipe(new CP_CraftCannabisBagFuture);
	...
	RegisterRecipe(new CP_CraftCannabisBagS1);
	...
	RegisterRecipe(new CP_CraftCannabisBagNomad);
	...
	RegisterRecipe(new CP_DeCraftCannabisBrickBlackFrost);
