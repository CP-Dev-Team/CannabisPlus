class CraftCigsCannabisBlue extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Blue God Cannabis Cigarettes";
		...
		InsertIngredient(0,"CannabisBlue");//you can insert multiple ingredients this way
