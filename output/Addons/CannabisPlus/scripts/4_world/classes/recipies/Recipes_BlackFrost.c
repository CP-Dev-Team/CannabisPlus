...
class CP_DeCraftCannabisBagBlackFrost extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open BlackFrost Cannabis Bag";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("CP_CannabisBlackFrost");//add results here
...
class CP_DeCraftCannabisBrickBlackFrost extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open BlackFrost Cannabis Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		InsertIngredient(0,"CP_CannabisBrickBlackFrost");//you can insert multiple ingredients this way
